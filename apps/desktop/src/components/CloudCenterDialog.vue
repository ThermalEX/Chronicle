...
.icon-sync { display: grid; place-items: center; width: 32px; height: 32px; margin-left: auto; color: #2563eb; background: #eff6ff; border-radius: 6px; }.icon-sync:hover { background: #dbeafe; }.icon-sync.paused { color: #15803d; background: #ecfdf3; }.icon-sync.paused:hover { background: #dcfce7; }.icon-danger { margin-left: 8px; }
